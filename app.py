...
from preprocessing import preprocess_dataset, prepare_model_data, encode_features
...
def render_ai_strategist():
    ...
    st.markdown(
        '<div class="page-subtitle">'
        "Explain recommendations and generate higher-level marketing actions."
        "</div>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        """
        <div class="card">
            <div class="decision-label">Phase 2 capability</div>
            <div class="decision-value">AI Marketing Strategist</div>
            <p class="small-note" style="margin-top:10px;">
                This interface is intentionally reserved for the RAG + LLM layer.
                Once connected, the strategist can use customer intelligence,
                segment behavior, campaign results and approved marketing
                knowledge to explain recommendations and suggest actions.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.info(
        "RAG / LangChain / LLM integration has not been connected yet. "
        "The core ML-driven decision engine is active."
    )
